...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts({bool filterByUser = false}) async {
    ...
    var url = Uri.parse(
        'https://flutter-shop-e1d3c-default-rtdb.firebaseio.com/products.json?auth=$authToken$filterString');
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          'https://flutter-shop-e1d3c-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
